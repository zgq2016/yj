  ...
  <div class="announcements" v-if="permission.indexOf('announcements')!=-1">
    ...
    <div class="main">
      ...
      >
        ...
        <el-table-column align="center" prop="ctime" label="状态"></el-table-column>
        <el-table-column align="center" prop="ctime" label="发布人"></el-table-column>
        <el-table-column align="center" prop="ctime" label="发布时间"></el-table-column>
        <el-table-column align="center" prop="ctime" label="回复人"></el-table-column>
        <el-table-column align="center" prop="ctime" label="回复时间"></el-table-column>
