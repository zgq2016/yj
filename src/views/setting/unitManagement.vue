<template>
  <div class="colorManagement" v-if="power.indexOf('H6000400')!=-1">
    ...
    <!-- 添加单位 -->
    <div class="addClassify" v-if="power.indexOf('H6000100')!=-1" @click="addClassify">添加单位</div>
    <el-table :data="tableData" style="width: 100%;margin: 20px 0;">
      <el-table-column prop="unit_name" label="单位名称" width="200"></el-table-column>
      <el-table-column
        align="right"
        label="操作"
        v-if="power.indexOf('H6000300')!=-1||power.indexOf('H6000200')!=-1"
      >
        <template slot-scope="scope">
          <div
            v-if="power.indexOf('H6000300')!=-1"
            class="el-icon-edit btn"
            @click="handleEdit(scope.$index, scope.row)"
          ></div>
          <div
            v-if="power.indexOf('H6000200')!=-1"
