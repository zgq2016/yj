      ...
      <el-header style="border-bottom:1px solid #eee;">
        ...
        >
          ...
          <el-submenu index="4" v-if="power.indexOf('C')!=-1">
            ...
            <el-menu-item index="/material" v-if="power.indexOf('C3000')!=-1">物料库存查询</el-menu-item>
            <el-menu-item index="/stockInquiry" v-if="power.indexOf('C4000')!=-1">物料入库</el-menu-item>
