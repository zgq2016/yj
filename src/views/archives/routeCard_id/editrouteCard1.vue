    ...
    <el-col class="form" style="margin-top:20px">
      <el-form :model="obj" ref="obj" :rules="rules" label-width="100px">
        ...
        <el-form-item label="幅宽" prop="breadth">
          <el-input v-model="obj.breadth" style="width:200px;" placeholder="cm"></el-input>
        </el-form-item>
        <el-form-item label="克重" prop="grammage">
          <el-input v-model="obj.grammage" style="width:200px;" placeholder="g"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async recognition(response, file, fileList) {
      ...
      let arr = this.pregMaterial(this.contents, this.materials);
      if (arr.length != 0) {
        this.obj.material_data = arr;
      }
      this.contents.map((v, i) => {
        this.s_company.map((v1, i1) => {
          if (v.words == v1.value) {
            this.obj.supplier_companyname = v1.value;
            this.obj.materials_supplier_id = i1.address;
          }
        });
        if (
          v.words.slice(0, 2) == "品名" ||
          ...
          if (v.words.indexOf(":") != -1) {
            this.obj.materialsno = v.words.slice(3);
          } else {
            this.obj.materialsno = v.words.slice(2);
          }
        }
      });
    },
