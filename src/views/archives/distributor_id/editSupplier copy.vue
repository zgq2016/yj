    ...
    <div class="form">
      <el-form :model="obj" ref="obj" :rules="rules" label-width="100px">
        ...
        <div style="display:flex;">
          <el-form-item label="分类" prop="materials_class_id">
            <el-select
              v-model="obj.materials_class_id"
              placeholder="请选择"
...
export default {
  ...
  methods: {
    ...
    async onCancel(val, num) {
      ...
      if (val == 1 && num == undefined) {
        ...
        this.obj.contact = this.matchPhone(this.contents);
        this.obj.address = this.address(this.contents);
  ...
  async mounted() {
    ...
    this.obj.materials_class_id = Number(res.data.data.materials_class_id)
    this.getBankName();
