<template>
  <div class="distributor">
    ...
    <el-dialog title="提示" :visible.sync="centerDialogVisible" width="30%" center>
      <el-input v-if="level===0" v-model="value" placeholder="请输入物料工艺卡分类名称" style="width:300px"></el-input>
      <el-input v-if="level===1" v-model="value" placeholder="请输入物料工艺卡分类名称" style="width:300px"></el-input>
